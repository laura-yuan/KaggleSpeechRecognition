...
def run_graph(wav_file_list, labels, input_layer_name, output_layer_name,
              num_top_predictions):
  ...
  with tf.Session() as sess:
    ...
    for wav in wav_file_list:
        ...
        if labels[top_k[0]] == '_unknown_':
            label_this_wav = 'unknown'
        elif labels[top_k[0]] == '_silence_':
            label_this_wav = 'silence'
        else:
            label_this_wav = labels[top_k[0]]
...
def label_wav(wav_file_list, labels, graph, input_name, output_name, how_many_labels):
